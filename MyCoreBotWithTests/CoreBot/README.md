...
- [.NET Core SDK](https://dotnet.microsoft.com/download) 2.2
...
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `MyCoreBotWithTests/CoreBot` folder
...
Generated with `dotnet new corebot` v4.6.2
